    ...
    <div className="public-shell">
      <header className="public-nav">
        <button className="brand-button" onClick={() => setView('public-create')}>
          <span className="brand-symbol">PA</span>
          <span><strong>Punto de Apoyo</strong><small>Coordinacion y respuesta para Venezuela</small></span>
        </button>
      ...
      <section className="public-hero">
        <div className="hero-copy">
          <div className="hero-logo"><img src="/punto-de-apoyo-logo.png" alt="Punto de Apoyo" /></div>
